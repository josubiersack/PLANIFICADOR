...
- "actividades": cada línea empieza con "• " y describe acciones concretas: saludo inicial en inglés, repaso visual, desarrollo de páginas del libro de inglés (indicar número de página), lectura y completación, vocabulario nuevo, socialización, corrección grupal, feedback. Cada viñeta debe comenzar con un VERBO EN INFINITIVO (Explicar, Realizar, Verificar, Corregir, Asignar, etc.), sin mencionar explícitamente "El docente" ni "Los estudiantes" como sujeto. Ejemplo del estilo correcto: "• Explicar la definición y uso de los pronombres relativos con ejemplos en la pizarra.", "• Realizar ejercicios de completar frases en la hoja de trabajo.", "• Verificar la comprensión mediante preguntas cortas." Ejemplo INCORRECTO (evitar): "• El docente explica la definición...", "• Los estudiantes escuchan, repiten y anotan...".
